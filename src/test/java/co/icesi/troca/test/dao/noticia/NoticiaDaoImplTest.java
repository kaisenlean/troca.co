...
public class NoticiaDaoImplTest  extends BaseUnit{
	...
	* @date 31/10/2013
	...
	public void findNoticiasByFechasTest(){
		...
		List<Noticia> noticias= noticiaDao.findNoticiasByFechas(fechaInicio.getTime(), fechaFIn.getTime());
	...
	/**
	 * Test method for {@link co.icesi.troca.repositories.impl.GenericJpaRepository#findById(java.io.Serializable)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link co.icesi.troca.repositories.impl.GenericJpaRepository#delete(java.lang.Object)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link co.icesi.troca.repositories.impl.GenericJpaRepository#save(java.lang.Object)}.
	 */
	@Test
