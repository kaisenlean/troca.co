...
public class CategoriaNecesitoServiceImpl extends
		GenericServiceImpl<CategoriaNecesito, Integer> implements Serializable,
		GenericService<CategoriaNecesito, Integer>, CategoriaNecesitoService {
	 ...
	 * @date 24/11/2013
	 * @param categoriaNecesitoDao
	 *            the categoriaNecesitoDao to set
	 */
