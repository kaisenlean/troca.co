...
public class NotificacionServiceImpl extends
		GenericServiceImpl<Notificacion, Integer> implements
		NotificacionService, Serializable {
	...
	public void crearNotificacionAdicionProyecto(ProyectoUsuario proyectoUsuario) {
		...
		notificacion.setReferenceId(proyectoUsuario.getProyecto().getId()
				.toString());
		notificacion.setUsuario(proyectoUsuario.getUsuario());
		notificacion.setMensaje(INVITACION_PROYECTO + " "
				+ proyectoUsuario.getProyecto().getNombre());
	 ...
	 * (non-Javadoc)
	 * 
	 * @see co.icesi.troca.services.notificacion.NotificacionService#crearNotificacionCancelarTrueque(co.icesi.troca.model.trueque.Trueque,
	...
	public void crearNotificacionCancelarTrueque(Trueque trueque,
		...
		notificacion.setEstado(EstadoNotificacion.NO_VISTA);
		notificacion
				.setUsuario(trueque.getUsuarioTrueque1().equals(usuario) ? trueque
						.getUsuarioTrueque2() : trueque.getUsuarioTrueque1());
		notificacion.setMensaje(new StringBuilder("Cancelaron tu trueque con ")
				.append(usuario.getNombreCompleto()).toString());
		notificacionDao.save(notificacion);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see co.icesi.troca.services.notificacion.NotificacionService#crearNotificacionComentarioNoticia(co.icesi.troca.model.trueque.TruequeTengo,
	 *      java.lang.String)
	 */
	@Override
	public void crearNotificacionComentarioNoticia(
			NoticiaComentario noticiaComentario) {
		...
		notificacion.setEstado(EstadoNotificacion.NO_VISTA);
		notificacion.setMensaje(notificacion.getUsuario().getNombreCompleto()
				+ " Ha comentado en tu noticia");
		notificacionDao.save(notificacion);
	 ...
	 */
	@Override
	public void crearNotificacionFinalizarTrueque(Trueque trueque,
			Usuario creador) {
		Notificacion notificacion = new Notificacion();
		...
		notificacion.setReferenceId(trueque.getId().toString());
		notificacion
				.setUsuario(trueque.getUsuarioTrueque1().equals(creador) ? trueque
						.getUsuarioTrueque2() : trueque.getUsuarioTrueque1());
		EstadoTruequeEnum estadoTruequeUsuario = trueque.getUsuarioTrueque1()
				.equals(creador) ? trueque.getEstadoUsuario1() : trueque
				.getEstadoUsuario2();
		EstadoTruequeEnum estado = trueque.getEstado();
		notificacion.setEstado(EstadoNotificacion.NO_VISTA);
		String msjComplemento = estado.equals(EstadoTruequeEnum.ACTIVO)
				&& estadoTruequeUsuario.equals(EstadoTruequeEnum.ACTIVO) ? "Para que se finalize realmente debes finalizarlo tu también"
				: "";
		notificacion
				.setMensaje(new StringBuilder("Finalizaron tu trueque con ")
						.append(creador.getNombreCompleto())
						.append(msjComplemento).toString());
		notificacionDao.save(notificacion);
	}
	 ...
	 */
	@Override
	public void crearNotificacionSolicitudTrueque(TruequeTengo truequeTengo,
			String mensaje) {
		Notificacion notificacion = new Notificacion();
		notificacion.setCreador(truequeTengo.getTrueque().getUsuarioTrueque1());
		notificacion.setFecha(new Date());
		notificacion.setModulo(Modulo.TRUEQUE_TENGO);
		notificacion.setReferenceId(truequeTengo.getTrueque().getId()
				.toString());
		notificacion.setUsuario(truequeTengo.getTrueque().getUsuarioTrueque2());
		notificacion.setEstado(EstadoNotificacion.NO_VISTA);
		notificacion
				.setMensaje("Yo necesito " + truequeTengo.getTengo2() == null ? null
						: truequeTengo.getTengo2().getNombre()
								+ " A cambio te puedo ofrecer "
								+ truequeTengo.getTengo() == null ? null
								: truequeTengo.getTengo().getNombre() + "\n"
										+ mensaje);
		notificacionDao.save(notificacion);
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see co.icesi.troca.services.notificacion.NotificacionService#crearNotificacionSolicitudTruequeProyecto(co.icesi.troca.model.trueque.TruequeTengo,
	 *      java.lang.String)
	 */
	@Override
	public void crearNotificacionSolicitudTruequeProyecto(
		...
		notificacion.setUsuario(truequeTengo.getTrueque().getUsuarioTrueque2());
		notificacion.setEstado(EstadoNotificacion.NO_VISTA);
		notificacion.setMensaje("Veo que necesitan "
				+ truequeTengo.getNecesito().getNombre()
				+ " Yo lo tengo y a cambio les pido "
				+ truequeTengo.getTengo().getNombre() + "\n" + mensaje);
		notificacionDao.save(notificacion);
	}
	...
	public void enviarNotificacionMensajeTrueque(TruequeMensaje truequeMensaje) {
		...
		notificacion.setReferenceId(truequeMensaje.getTrueque().getId()
				.toString());
		notificacion.setUsuario(truequeMensaje.getUsuarioReceptor());
		notificacion.setEstado(EstadoNotificacion.NO_VISTA);
		notificacion.setMensaje("Nueva respuesta en tu trueque con "
				+ truequeMensaje.getUsuarioEmisor().getNombreCompleto());
		notificacionDao.save(notificacion);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see co.icesi.troca.services.notificacion.NotificacionService#findNotificacionesUsuario(co.icesi.troca.model.usuario.Usuario,
	 *      int)
	 */
	@Override
