...
public class BeanNoticia extends BaseBean implements Serializable {
	 ...
	 *         MAX_NOTICES_SIZE
	 */
	private static final int MAX_NOTICES_SIZE = 7;
	...
	public void agregarComentario() {
		...
		comentarios = noticiaComentarioService
				.findComentariosByNoticia(noticia);
	...
	public void init() {
		...
		ultimasNoticias2 = noticiaService.findUltimasNoticias(MAX_NOTICES_SIZE);
	 ...
	 * @author <a href="elmerdiazlazo@gmail.com">Elmer Jose Diaz Lazo</a>
	 * @date 9/12/2013
	 * @param noticiaComentarioService
	 *            the noticiaComentarioService to set
	 */
	 ...
	 * @author <a href="elmerdiazlazo@gmail.com">Elmer Jose Diaz Lazo</a>
	 * @date 1/12/2013
	 * @param ultimasNoticias2
	 *            the ultimasNoticias2 to set
	 */
